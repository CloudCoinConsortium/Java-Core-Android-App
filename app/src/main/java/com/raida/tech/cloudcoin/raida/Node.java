...
public class Node {
    ...
    public class MultiDetectResponse {
        public com.raida.tech.cloudcoin.raida.Response[] responses;
    }
    ...
    public CompletableFuture<MultiDetectResponse> MultiDetect(int[] nn, int[] sn, String[] an, String[] pan, int[] d, int timeout) {
        com.raida.tech.cloudcoin.raida.Response[] response = new com.raida.tech.cloudcoin.raida.Response[nn.length];
        for (int i = 0; i < nn.length; i++) {
            response[i] = new com.raida.tech.cloudcoin.raida.Response();
        }
